...
main (int argc, char* argv[])
{
  ...
  unsigned int win_width = (display_width / 3);
  unsigned int win_height = (display_height / 3);
  ...
  Window win = create_simple_window(display, win_width, win_height, 0, 0);
...

  {
    ...
    win_size_hints->min_width = 000;
    win_size_hints->min_height = 000;
